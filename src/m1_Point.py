...
class Point(object):
    ...
    def move_to(self, dx, dy):
        self.distance_moved = self.distance_moved + math.sqrt(((self.x - dx) ** 2) + ((self.y - dy) ** 2))
        self.x = dx
        self.y = dy
    ...
    def get_distance_from(self,Point):
        self.distance_moved = math.sqrt(((self.x - Point.x)** 2) +((self.y - Point.y)** 2))
        return self.distance_moved
    def get_distance_from_start(self):
        self.distance_moved = math.sqrt(((self.xi - self.x )** 2) +((self.yi - self.y)** 2))
        return self.distance_moved
